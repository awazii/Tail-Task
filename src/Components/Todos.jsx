  ...
  return (
    <div className='todocontainer mx-auto container h-[80vh] flex '>
      ...
      { list.tasks.length > 0 && <><div className="toggle-complete  flex items-center justify-between px-8 pt-4">
        ...
        <div className="todos-list pt-4 space-y-4 w-full sm:max-h-[45%] max-h-[32%] px-8 overflow-auto   [&::-webkit-scrollbar-thumb]:bg-neutral-500/50  dark:[&::-webkit-scrollbar-thumb]:bg-neutral-700 ">
          {list.tasks.map(task => (
